...
apiku = 'http://wa.me/6289668014332'
gc_wa_lu = 'https://chat.whatsapp.com/Ev930hwkdnrAON0V6za57c' //klo gk punya gc wa gk usah di ganti 👍
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} itu owner ku, gak maksa save kakak😇`
var buttonss = [
